...
public class ContactAdapter extends BaseAdapter implements LoaderManager.LoaderCallbacks<Cursor> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (fileDescriptor != null) {
			Bitmap image = BitmapFactory.decodeFileDescriptor(fileDescriptor, null, null);
			viewHolder.contactPhotoImageView.setImageBitmap(image);
		}
	      }
	    ...
	    viewHolder.contactTimesContactedTextView.setText(contact.getName());
	    ...
	    //viewHolder.contactLastTimeContactedTextView.setText(contact.getTimesContacted());
