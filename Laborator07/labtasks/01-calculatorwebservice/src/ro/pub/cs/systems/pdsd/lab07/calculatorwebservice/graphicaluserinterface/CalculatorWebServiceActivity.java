...
public class CalculatorWebServiceActivity extends Activity {
	...
	private class CalculatorWebServiceThread extends Thread {
		...
		public void run() {
			...
			String method = ((Spinner)findViewById(R.id.methods_spinner)).getSelectedItem().toString();
			
			operator1 = Integer.parseInt(((EditText)findViewById(R.id.operator1_edit_text)).getText().toString());
			operator2 = Integer.parseInt(((EditText)findViewById(R.id.operator2_edit_text)).getText().toString());
			...
			if(method.equals("POST")) {
				...
				try {
				  ...
				  ResponseHandler<String> responseHan = new BasicResponseHandler();
				  result += httpClient.execute(httpPost, responseHan);
			...
			Log.e("TAGGGG", tmpResult);
			resultTextView = ((TextView)findViewById(R.id.result_text_view));
			resultTextView.post(new Runnable() {
		        @Override
				public void run() {
					resultTextView.setText(tmpResult);
				}
			});
